...
# NOTE: taken from
# https://github.com/fabacab/git-archive-all.sh/blob/fc86194f00b678438f9210859597f6eead28e765/git-archive-all.sh
...
if [ "-" == "$OUT_FILE" -o $SEPARATE -ne 1 ] && [ "$FORMAT" == "tar" -a $(
	$TARCMD --help | grep -q -- "--concatenate"
	echo $?
) -ne 0 ]; then
	...
	git config -l | grep -q '^core\.bare=true'
	echo $?
) -eq 0 ]; then
